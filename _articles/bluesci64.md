...
<div class="row justify-content-center">
    <div class="col-sm-10 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/bluesci64/thumbnail.jpg" title="BlueSci Issue 63 — The Loneliest Places in the Universe" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
