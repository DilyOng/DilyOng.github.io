...
<div class="row justify-content-center">
    <div class="col-sm-6 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/ioa-open-evenings/dobsonian.jpg" title="12.5-inch Dobsonian telescope at the Institute of Astronomy" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
